...
Claude reads it and drafts multiple-choice questions; the lecturer reviews and approves them;
...
- **AI:** Anthropic Claude API for question generation from extracted PDF text
...
gstprep-ai/
  backend/
    src/
      ...
      services/      # PDF extraction, Claude integration
      utils/         # seed script
      app.js
      server.js
...
4. Each chunk is sent to Claude with a strict system prompt requiring valid JSON output:
